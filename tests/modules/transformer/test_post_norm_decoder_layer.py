...
@pytest.fixture
def module() -> PostNormDecoderLayer:
...
def test_output_shape(module: PostNormDecoderLayer):
...
def test_gradient_flow(module: PostNormDecoderLayer):
...
def test_predict_no_cache(module: PostNormDecoderLayer):
    module.eval()
...
def test_predict_cache(module: PostNormDecoderLayer):
    module.eval()
